...
namespace NetStream.Server
{
    ...
    public class StartupOptions : IStartupOptions
    {
        ...
        [Option('w', "webdir", Required = false, HelpText = "Path to the NetStream web UI resources.")]
        ...
        /// <inheritdoc />
        [Option("package-name", Required = false, HelpText = "Used when packaging NetStream (example, synology).")]
        public string? PackageName { get; set; }

        /// <inheritdoc />
        [Option("published-server-url", Required = false, HelpText = "NetStream Server URL to publish via auto discover process")]
        ...
        /// <summary>
        /// Gets or sets the path to an netstream backup archive to restore the application to.
        /// </summary>
        [Option("restore-archive", Required = false, HelpText = "Path to a NetStream backup archive to restore from")]
        ...
        /// </summary>
        [Option("mode", Required = false, HelpText = "Mode which selects what action the netstream server should perform when started.")]
