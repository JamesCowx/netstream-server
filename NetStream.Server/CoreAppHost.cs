...
using NetStream.Api.WebSocketListeners;
using NetStream.Database.Implementations;
using NetStream.Drawing;
using NetStream.Drawing.Skia;
using NetStream.LiveTv;
using NetStream.Server.Implementations.Activity;
using NetStream.Server.Implementations.Devices;
using NetStream.Server.Implementations.Events;
using NetStream.Server.Implementations.Extensions;
using NetStream.Server.Implementations.Security;
using NetStream.Server.Implementations.Trickplay;
...
namespace NetStream.Server
{
    ...
    public class CoreAppHost : ApplicationHost
    {
        ...
        protected override IEnumerable<Assembly> GetAssembliesWithPartsInternal()
        {
            ...
            // NetStream.Database.Implementations
            yield return typeof(NetStreamDbContext).Assembly;

            // NetStream.Server.Implementations
