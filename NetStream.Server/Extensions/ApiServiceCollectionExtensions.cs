...
using NetStream.Api.Auth;
using NetStream.Api.Auth.AnonymousLanAccessPolicy;
using NetStream.Api.Auth.DefaultAuthorizationPolicy;
using NetStream.Api.Auth.FirstTimeSetupPolicy;
using NetStream.Api.Auth.LocalAccessOrRequiresElevationPolicy;
using NetStream.Api.Auth.SyncPlayAccessPolicy;
using NetStream.Api.Auth.UserPermissionPolicy;
using NetStream.Api.Constants;
using NetStream.Api.Controllers;
using NetStream.Api.Formatters;
using NetStream.Api.ModelBinders;
using NetStream.Data.Enums;
using NetStream.Database.Implementations.Enums;
using NetStream.Extensions.Json;
using NetStream.Server.Configuration;
using NetStream.Server.Filters;
...
using AuthenticationSchemes = NetStream.Api.Constants.AuthenticationSchemes;

namespace NetStream.Server.Extensions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Adds netstream API authorization policies to the DI container.
        /// </summary>
        /// <param name="serviceCollection">The service collection.</param>
        /// <returns>The updated service collection.</returns>
        public static IServiceCollection AddNetStreamApiAuthorization(this IServiceCollection serviceCollection)
        {
        ...
        /// <summary>
        /// Extension method for adding the NetStream API to the service collection.
        /// </summary>
        /// <param name="serviceCollection">The service collection.</param>
        /// <param name="pluginAssemblies">An IEnumerable containing all plugin assemblies with API controllers.</param>
        /// <param name="config">The <see cref="NetworkConfiguration"/>.</param>
        /// <returns>The MVC builder.</returns>
        public static IMvcBuilder AddNetStreamApi(this IServiceCollection serviceCollection, IEnumerable<Assembly> pluginAssemblies, NetworkConfiguration config)
        {
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <returns>The updated service collection.</returns>
        public static IServiceCollection AddNetStreamApiSwagger(this IServiceCollection serviceCollection)
        {
