...
public static class WebHostBuilderExtensions
{
    ...
    public static void SetupNetStreamWebServer(
        ...
        foreach (var netAdd in addresses)
        {
            ...
            if (httpsPort.HasValue)
            {
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException("Cannot run netstream with https without setting a valid certificate.");
                    }
