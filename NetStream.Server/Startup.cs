...
using NetStream.Api.Middleware;
using NetStream.Database.Implementations;
using NetStream.LiveTv.Extensions;
using NetStream.LiveTv.Recordings;
using NetStream.MediaEncoding.Hls.Extensions;
using NetStream.Networking;
using NetStream.Networking.HappyEyeballs;
using NetStream.Server.Extensions;
using NetStream.Server.HealthChecks;
...
namespace NetStream.Server
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddNetStreamApi(_serverApplicationHost.GetApiPluginAssemblies(), _serverConfigurationManager.GetNetworkConfiguration());
            services.AddNetStreamDbContext(_serverApplicationHost.ConfigurationManager, _configuration);
            services.AddNetStreamApiSwagger();

            // configure custom legacy authentication
            services.AddCustomAuthentication();

            services.AddNetStreamApiAuthorization();
            ...
            services.AddHealthChecks()
                .AddCheck<DbContextFactoryHealthCheck<NetStreamDbContext>>(nameof(NetStreamDbContext));
            ...
            IConfiguration appConfig)
        {
            ...
            app.Map(config.BaseUrl, mainApp =>
            {
                ...
                mainApp.UseNetStreamApiSwagger(_serverConfigurationManager);
