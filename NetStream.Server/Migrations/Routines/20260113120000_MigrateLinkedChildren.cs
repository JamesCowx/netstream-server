...
using LinkedChildType = NetStream.Database.Implementations.Entities.LinkedChildType;
...
/// </summary>
[NetStreamMigration("2026-01-13T12:00:00", nameof(MigrateLinkedChildren))]
...
internal class MigrateLinkedChildren : IDatabaseMigrationRoutine
{
    ...
    private void CleanupWrongTypeAlternateVersions(NetStreamDbContext context)
    {
    ...
    private void CleanupOrphanedAlternateVersionBaseItems(NetStreamDbContext context)
    {
    ...
    private void CleanupItemsFromDeletedLibraries(NetStreamDbContext context)
    {
    ...
    private void CleanupStaleFileEntries(NetStreamDbContext context)
    {
    ...
    private void CleanupOrphanedLinkedChildren(NetStreamDbContext context)
    {
