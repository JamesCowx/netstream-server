...
/// </summary>
[NetStreamMigration("2026-05-08T13:00:00", nameof(MergeDuplicatePeople))]
...
public class MergeDuplicatePeople : IAsyncMigrationRoutine
{
    ...
    private async Task MergePersonBaseItemsAsync(NetStreamDbContext context, CancellationToken cancellationToken)
    {
    ...
    private async Task MergePeoplesRowsAsync(NetStreamDbContext context, CancellationToken cancellationToken)
    {
