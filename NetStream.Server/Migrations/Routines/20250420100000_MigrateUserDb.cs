...
[NetStreamMigration("2025-04-20T10:00:00", nameof(MigrateUserDb), "5C4B82A2-F053-4009-BD05-B6FCAD82F14C")]
...
#pragma warning restore CS0618 // Type or member is obsolete
{
    ...
    public void Perform()
    {
        ...
        _logger.LogInformation("Migrating the user database may take a while, do not stop NetStream.");
        ...
        using (var connection = new SqliteConnection($"Filename={userDbPath}"))
        {
            ...
            foreach (var entry in queryResult)
            {
                ...
                policy.AuthenticationProviderId = policy.AuthenticationProviderId?.Replace(
                    ...
                    "NetStream.Server.Implementations.Users",
