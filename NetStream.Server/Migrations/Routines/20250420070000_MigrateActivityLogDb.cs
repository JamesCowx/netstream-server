...
#pragma warning disable CS0618 // Type or member is obsolete
    [NetStreamMigration("2025-04-20T07:00:00", nameof(MigrateActivityLogDb), "3793eb59-bc8c-456c-8b9f-bd5a62a42978")]
...
#pragma warning restore CS0618 // Type or member is obsolete
    {
        ...
        public MigrateActivityLogDb(ILogger<MigrateActivityLogDb> logger, IServerApplicationPaths paths, IDbContextFactory<NetStreamDbContext> provider)
        {
            _logger = logger;
            _provider = provider;
            _paths = paths;
        ...
        public void Perform()
        {
            ...
            using (var connection = new SqliteConnection($"Filename={activityLogPath}"))
            {
                ...
                _logger.LogWarning("Migrating the activity database may take a while, do not stop NetStream.");
