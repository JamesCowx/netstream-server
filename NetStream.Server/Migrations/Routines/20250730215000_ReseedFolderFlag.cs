...
[NetStreamMigration("2025-07-30T21:50:00", nameof(ReseedFolderFlag))]
...
internal class ReseedFolderFlag : IAsyncMigrationRoutine
{
    ...
    public async Task PerformAsync(CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("Migrating the IsFolder flag from library.db.old may take a while, do not stop NetStream.");
