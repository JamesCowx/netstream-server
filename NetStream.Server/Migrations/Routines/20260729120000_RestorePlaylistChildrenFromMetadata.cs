...
/// </summary>
[NetStreamMigration("2026-07-29T12:00:00", nameof(RestorePlaylistChildrenFromMetadata))]
internal class RestorePlaylistChildrenFromMetadata : IDatabaseMigrationRoutine
{
    ...
    public void Perform()
    {
        ...
        {
            // Only directory-based (NetStream-managed) playlists keep their entries in playlist.xml.
