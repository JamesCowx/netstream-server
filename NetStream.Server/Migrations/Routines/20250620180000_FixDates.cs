...
/// </summary>
[NetStreamMigration("2025-06-20T18:00:00", nameof(FixDates))]
public class FixDates : IAsyncMigrationRoutine
{
    ...
    /// <param name="dbProvider">Instance of the <see cref="IDbContextFactory{NetStreamDbContext}"/> interface.</param>
    public FixDates(
    ...
    private async Task FixBaseItemsAsync(NetStreamDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixChaptersAsync(NetStreamDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixBaseItemImageInfos(NetStreamDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
