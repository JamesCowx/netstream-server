...
/// <summary>
/// Migration to update the default NetStream plugin repository.
/// </summary>
#pragma warning disable CS0618 // Type or member is obsolete
[NetStreamMigration("2025-04-20T17:00:00", nameof(UpdateDefaultPluginRepository), "852816E0-2712-49A9-9240-C6FC5FCAD1A8", RunMigrationOnSetup = true)]
public class UpdateDefaultPluginRepository : IMigrationRoutine
#pragma warning restore CS0618 // Type or member is obsolete
{
    private const string NewRepositoryUrl = "https://repo.netstream.org/files/plugin/manifest.json";
    private const string OldRepositoryUrl = "https://repo.netstream.org/releases/plugin/manifest-stable.json";
