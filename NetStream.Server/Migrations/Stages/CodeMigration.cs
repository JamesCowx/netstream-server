...
internal class CodeMigration(Type migrationType, NetStreamMigrationAttribute metadata, NetStreamMigrationBackupAttribute? migrationBackupAttribute)
{
    public Type MigrationType { get; } = migrationType;

    public NetStreamMigrationAttribute Metadata { get; } = metadata;

    public NetStreamMigrationBackupAttribute? BackupRequirements { get; set; } = migrationBackupAttribute;
