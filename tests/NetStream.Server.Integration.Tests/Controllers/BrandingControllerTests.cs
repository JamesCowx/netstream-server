...
{
    public sealed class BrandingControllerTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;

        public BrandingControllerTests(NetStreamApplicationFactory factory)
        {
            _factory = factory;
        }
