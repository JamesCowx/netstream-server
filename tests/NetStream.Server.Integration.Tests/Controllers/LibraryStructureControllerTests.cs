...
using NetStream.Api.Models.LibraryStructureDto;
...
public sealed class LibraryStructureControllerTests : IClassFixture<NetStreamApplicationFactory>
{
    private readonly NetStreamApplicationFactory _factory;
    private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
    private static string? _accessToken;

    public LibraryStructureControllerTests(NetStreamApplicationFactory factory)
    {
        _factory = factory;
    }
