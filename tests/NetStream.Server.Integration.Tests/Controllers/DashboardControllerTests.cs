...
using NetStream.Api.Models;
using NetStream.Extensions.Json;
using Xunit;

namespace NetStream.Server.Integration.Tests.Controllers
{
    public sealed class DashboardControllerTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;
        private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
        private static string? _accessToken;

        public DashboardControllerTests(NetStreamApplicationFactory factory)
        {
            _factory = factory;
        }
        ...
        public async Task GetDashboardConfigurationPage_ExistingPage_CorrectPage()
        {
            ...
            StreamReader reader = new StreamReader(typeof(TestPlugin).Assembly.GetManifestResourceStream("NetStream.Server.Integration.Tests.TestPage.html")!);
