...
{
    public sealed class ActivityLogControllerTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;
        private static string? _accessToken;

        public ActivityLogControllerTests(NetStreamApplicationFactory factory)
        {
            _factory = factory;
        }
