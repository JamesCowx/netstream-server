...
{
    public sealed class MediaStructureControllerTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;
        private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
        private static string? _accessToken;

        public MediaStructureControllerTests(NetStreamApplicationFactory factory)
        {
            _factory = factory;
        }
