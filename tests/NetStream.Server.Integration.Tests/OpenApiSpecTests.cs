...
{
    public sealed class OpenApiSpecTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;
        private readonly ITestOutputHelper _outputHelper;

        public OpenApiSpecTests(NetStreamApplicationFactory factory, ITestOutputHelper outputHelper)
        {
            _factory = factory;
