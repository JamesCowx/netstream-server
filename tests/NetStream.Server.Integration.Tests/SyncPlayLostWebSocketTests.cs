...
using NetStream.Api.Models.SyncPlayDtos;
...
public sealed class SyncPlayLostWebSocketTests : IClassFixture<NetStreamApplicationFactory>
{
    private readonly NetStreamApplicationFactory _factory;

    public SyncPlayLostWebSocketTests(NetStreamApplicationFactory factory)
    {
        _factory = factory;
    }
