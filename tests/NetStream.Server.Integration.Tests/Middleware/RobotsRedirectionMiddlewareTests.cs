...
namespace NetStream.Server.Integration.Tests.Middleware
{
    public sealed class RobotsRedirectionMiddlewareTests : IClassFixture<NetStreamApplicationFactory>
    {
        private readonly NetStreamApplicationFactory _factory;

        public RobotsRedirectionMiddlewareTests(NetStreamApplicationFactory factory)
        {
            _factory = factory;
        }
