...
namespace NetStream.Api.Tests.Auth
{
    public class CustomAuthenticationHandlerTests
    {
        private readonly IFixture _fixture;

        private readonly Mock<IAuthService> _netstreamAuthServiceMock;
        ...
        public CustomAuthenticationHandlerTests()
        {
            ...
            _netstreamAuthServiceMock = _fixture.Freeze<Mock<IAuthService>>();
        ...
        public async Task HandleAuthenticateAsyncShouldProvideNoResultOnAuthenticationException()
        {
            ...
            _netstreamAuthServiceMock.Setup(
                    a => a.Authenticate(
