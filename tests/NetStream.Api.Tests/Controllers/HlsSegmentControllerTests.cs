...
public sealed class HlsSegmentControllerTests
{
    ...
    {
        _transcodePath = Path.Combine(Path.GetTempPath(), "netstream-hls-segment-tests");
    ...
    public void GetHlsAudioSegmentLegacy_SiblingPrefixDirectory_ReturnsBadRequest()
    {
        ...
        var result = controller.GetHlsAudioSegmentLegacy("abc", "../netstream-hls-segment-tests-evil/passwd");
