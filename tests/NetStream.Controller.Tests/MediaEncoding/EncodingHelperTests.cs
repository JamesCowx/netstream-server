...
namespace NetStream.Controller.Tests.MediaEncoding;
...
public class EncodingHelperTests
{
    ...
    public void GetMapArgs_SecondExternalSrt_StillMaps1Colon0()
    {
        ...
        // because NetStream feeds only the selected file as ffmpeg input 1.
    ...
    {
        var tempDir = Directory.CreateTempSubdirectory("netstream-test-");
        try
        {
