...
namespace NetStream.Server.Implementations.Devices
{
    /// <summary>
    ...
    public class DeviceManager : IDeviceManager
    {
        ...
        public DeviceManager(IDbContextFactory<NetStreamDbContext> dbProvider, IUserManager userManager)
        {
