...
/// </remarks>
public class PeopleRepository(IDbContextFactory<NetStreamDbContext> dbProvider, IItemTypeLookup itemTypeLookup) : IPeopleRepository
{
    private readonly IDbContextFactory<NetStreamDbContext> _dbProvider = dbProvider;
    ...
    private IQueryable<People> TranslateQuery(IQueryable<People> query, NetStreamDbContext context, InternalPeopleQuery filter)
    {
