...
public sealed partial class BaseItemRepository
{
    ...
    private IReadOnlyList<BaseItemDto> GetLatestTvShowItems(NetStreamDbContext context, IQueryable<BaseItemEntity> baseQuery, InternalItemsQuery filter, int? limit)
    {
