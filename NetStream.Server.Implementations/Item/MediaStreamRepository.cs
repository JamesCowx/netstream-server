...
public class MediaStreamRepository : IMediaStreamRepository
{
    ...
    public MediaStreamRepository(IDbContextFactory<NetStreamDbContext> dbProvider, IServerApplicationHost serverApplicationHost, ILocalizationManager localization)
    {
