...
namespace NetStream.Server.Implementations.Item;

public sealed partial class BaseItemRepository
{
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> PrepareItemQuery(NetStreamDbContext context, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyQueryFilter(IQueryable<BaseItemEntity> dbQuery, NetStreamDbContext context, InternalItemsQuery filter)
    {
    ...
    /// </summary>
    private IQueryable<BaseItemEntity> ApplyAdjacencyFilter(NetStreamDbContext context, IQueryable<BaseItemEntity> dbQuery, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyGroupingFilter(NetStreamDbContext context, IQueryable<BaseItemEntity> dbQuery, InternalItemsQuery filter)
    {
    ...
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> ApplyOrder(IQueryable<BaseItemEntity> query, InternalItemsQuery filter, NetStreamDbContext context)
    {
    ...
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> GetAccessFilteredLeafItemsQuery(NetStreamDbContext context, User user, bool includeOwnedItems = false)
    {
    ...
    /// <inheritdoc />
    public Expression<Func<BaseItemEntity, bool>> BuildHasDescendantFilter(NetStreamDbContext context, IQueryable<BaseItemEntity> descendants)
    {
        ArgumentNullException.ThrowIfNull(context);
