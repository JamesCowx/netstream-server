...
using DbLinkedChildType = NetStream.Database.Implementations.Entities.LinkedChildType;
...
public class LinkedChildrenService : ILinkedChildrenService
{
    ...
    public void UpsertLinkedChild(Guid parentId, Guid childId, LinkedChildType childType)
    {
        ...
        if (existingLink is null)
        {
            ...
            context.LinkedChildren.Add(new NetStream.Database.Implementations.Entities.LinkedChildEntity
            {
                ParentId = parentId,
                ChildId = childId,
