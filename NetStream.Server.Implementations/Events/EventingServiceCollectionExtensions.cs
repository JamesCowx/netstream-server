using NetStream.Data.Events.System;
using NetStream.Data.Events.Users;
using NetStream.Server.Implementations.Events.Consumers.Library;
using NetStream.Server.Implementations.Events.Consumers.Security;
using NetStream.Server.Implementations.Events.Consumers.Session;
using NetStream.Server.Implementations.Events.Consumers.System;
using NetStream.Server.Implementations.Events.Consumers.Updates;
using NetStream.Server.Implementations.Events.Consumers.Users;
...
namespace NetStream.Server.Implementations.Events
{
    /// <summary>
