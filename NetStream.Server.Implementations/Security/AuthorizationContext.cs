...
namespace NetStream.Server.Implementations.Security
{
    public class AuthorizationContext : IAuthorizationContext
    {
        private readonly IDbContextFactory<NetStreamDbContext> _netstreamDbProvider;
        ...
        public AuthorizationContext(
            IDbContextFactory<NetStreamDbContext> netstreamDb,
            IUserManager userManager,
            IDeviceManager deviceManager,
            IServerApplicationHost serverApplicationHost,
            IServerConfigurationManager configurationManager)
        {
            _netstreamDbProvider = netstreamDb;
            ...
            IQueryCollection queryString)
        {
            ...
            var dbContext = await _netstreamDbProvider.CreateDbContextAsync().ConfigureAwait(false);
