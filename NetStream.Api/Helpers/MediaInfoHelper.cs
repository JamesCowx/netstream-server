...
using NetStream.Api.Extensions;
...
namespace NetStream.Api.Helpers;
...
public class MediaInfoHelper
{
    ...
    /// URL when it points at a NetStream-hosted live stream buffer, so response copies never leak server-local
    ...
    /// <summary>
    /// Resolves a NetStream-hosted Live TV buffer path to its request-appropriate published equivalent.
    /// Returns null when the path isn't a NetStream-hosted <c>/LiveTv/LiveStreamFiles/</c> HTTP URL.
    /// </summary>
