...
namespace Emby.Server.Implementations
{
    ...
    public class ServerApplicationPaths : BaseApplicationPaths, IServerApplicationPaths
    {
        ...
        /// </summary>
        /// <param name="programDataPath">The path for NetStream's data.</param>
        /// <param name="logDirectoryPath">The path for NetStream's logging directory.</param>
        /// <param name="configurationDirectoryPath">The path for NetStream's configuration directory.</param>
        /// <param name="cacheDirectoryPath">The path for NetStream's cache directory.</param>
        /// <param name="webDirectoryPath">The path for NetStream's web UI.</param>
