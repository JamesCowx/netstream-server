using NetStream.LiveTv.Channels;
using NetStream.LiveTv.Guide;
using NetStream.LiveTv.IO;
using NetStream.LiveTv.Listings;
using NetStream.LiveTv.Recordings;
using NetStream.LiveTv.Timers;
using NetStream.LiveTv.TunerHosts;
using NetStream.LiveTv.TunerHosts.HdHomerun;
using MediaBrowser.Controller.Channels;
using MediaBrowser.Controller.LiveTv;
using MediaBrowser.Model.IO;
using Microsoft.Extensions.DependencyInjection;

namespace NetStream.LiveTv.Extensions;
