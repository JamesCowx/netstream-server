...
using NetStream.MediaEncoding.Keyframes;
using Microsoft.Extensions.Logging;
using Extractor = NetStream.MediaEncoding.Keyframes.Matroska.MatroskaKeyframeExtractor;

namespace NetStream.MediaEncoding.Hls.Extractors;
