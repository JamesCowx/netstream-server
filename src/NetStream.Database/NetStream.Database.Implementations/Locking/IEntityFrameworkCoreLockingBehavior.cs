...
namespace NetStream.Database.Implementations.Locking;

/// <summary>
/// Defines a netstream locking behavior that can be configured.
/// </summary>
public interface IEntityFrameworkCoreLockingBehavior
{
    ...
    void OnSaveChanges(NetStreamDbContext context, Action saveChanges);
    ...
    Task OnSaveChangesAsync(NetStreamDbContext context, Func<Task> saveChanges);
}
