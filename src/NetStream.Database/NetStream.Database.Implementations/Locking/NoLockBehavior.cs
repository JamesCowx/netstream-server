...
public class NoLockBehavior : IEntityFrameworkCoreLockingBehavior
{
    ...
    /// <inheritdoc/>
    public void OnSaveChanges(NetStreamDbContext context, Action saveChanges)
    {
        saveChanges();
    }
    ...
    /// <inheritdoc/>
    public async Task OnSaveChangesAsync(NetStreamDbContext context, Func<Task> saveChanges)
    {
