...
public sealed class NetStreamDatabaseProviderKeyAttribute : System.Attribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NetStreamDatabaseProviderKeyAttribute"/> class.
    /// </summary>
    /// <param name="databaseProviderKey">The key on which to identify the annotated provider.</param>
    public NetStreamDatabaseProviderKeyAttribute(string databaseProviderKey)
    {
