...
using NetStream.Database.Implementations.MatchCriteria;

namespace NetStream.Database.Implementations;
...
public static class DescendantQueryHelper
{
    ...
    public static IQueryable<Guid> GetAllDescendantIds(NetStreamDbContext context, Guid parentId)
    {
    ...
    public static IQueryable<Guid> GetOwnedDescendantIds(NetStreamDbContext context, Guid parentId)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static HashSet<Guid> GetOwnedDescendantIdsBatch(NetStreamDbContext context, IReadOnlyList<Guid> parentIds)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static IQueryable<Guid> GetFolderIdsMatching(NetStreamDbContext context, FolderMatchCriteria criteria)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    private static HashSet<Guid> GetMatchingMediaStreamItemIds(NetStreamDbContext context, HasMediaStreamType criteria)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDown(NetStreamDbContext context, ICollection<Guid> startIds)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDownOwned(NetStreamDbContext context, ICollection<Guid> startIds)
    {
        var visited = new HashSet<Guid>(startIds);
        var folderStack = new HashSet<Guid>(startIds);
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyUp(NetStreamDbContext context, ICollection<Guid> startIds)
    {
