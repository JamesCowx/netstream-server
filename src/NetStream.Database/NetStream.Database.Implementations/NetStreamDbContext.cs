...
using NetStream.Database.Implementations.Entities.Security;
using NetStream.Database.Implementations.Interfaces;
...
/// <inheritdoc/>
/// <summary>
/// Initializes a new instance of the <see cref="NetStreamDbContext"/> class.
/// </summary>
/// <param name="options">The database context options.</param>
/// <param name="logger">Logger.</param>
/// <param name="netstreamDatabaseProvider">The provider for the database engine specific operations.</param>
/// <param name="entityFrameworkCoreLocking">The locking behavior.</param>
public class NetStreamDbContext(DbContextOptions<NetStreamDbContext> options, ILogger<NetStreamDbContext> logger, INetStreamDatabaseProvider netstreamDatabaseProvider, IEntityFrameworkCoreLockingBehavior entityFrameworkCoreLocking) : DbContext(options)
{
    /// <summary>
    ...
    /// <summary>
    /// Repository for global::NetStream.Data.Entities.RatingSource - This is the entity to
    ...
    {
        netstreamDatabaseProvider.OnModelCreating(modelBuilder);
        base.OnModelCreating(modelBuilder);

        // Configuration for each entity is in its own class inside 'ModelConfiguration'.
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(NetStreamDbContext).Assembly);
    }

    /// <inheritdoc />
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        netstreamDatabaseProvider.ConfigureConventions(configurationBuilder);
