...
public class NetworkConfiguration
{
    ...
    /// <summary>
    /// Gets or sets a value used to specify the URL prefix that your NetStream instance can be accessed at.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the interface addresses which NetStream will bind to. If empty, all interfaces will be used.
    /// </summary>
