...
1. Original work: [ListenBrainz logo](https://github.com/metabrainz/metabrainz-logos/commit/10127d3e84e5bb7e1c8509f1da12223d19581e18)
   ...
   CC BY-SA 4.0.
2. "ListenBrainz logo for NetStream plugin" — derivative by
   [lyarenei](https://github.com/lyarenei), distributed in
   [netstream-plugin-listenbrainz](https://github.com/lyarenei/netstream-plugin-listenbrainz/tree/main/res/listenbrainz)
   under CC BY-SA 4.0.
3. This redistribution within NetStream retains the work unmodified and remains
