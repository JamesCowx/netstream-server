...
public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages, IHasEmbeddedImage, IDisposable
{
        ...
        : base(applicationPaths, xmlSerializer)
    {
        ...
        // TODO: Change this to "NetStreamMusicBrainzPlugin" once we take it out of the server repo.
    ...
    public override string ConfigurationFileName => "NetStream.Plugin.MusicBrainz.xml";

    /// <inheritdoc />
    public string ImageResourceName => GetType().Namespace + ".netstream-plugin-musicbrainz.svg";
